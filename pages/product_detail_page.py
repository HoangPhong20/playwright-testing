...
class ProductDetailPage:
    ...
    def get_description(self) -> str:
        return self.page.locator(ProductDetailLocators.DESCRIPTION).first.inner_text().strip()

    def get_price(self) -> str:
        return self.page.locator(ProductDetailLocators.PRODUCT_PRICE).first.inner_text().strip()
